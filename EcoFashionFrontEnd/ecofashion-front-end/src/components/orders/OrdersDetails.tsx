    ...
    const load = async () => {
      try {
        ...
        if (user?.role === "supplier") {
          ...
          const isSellerOrder = supplierOrders.some((o) => o.orderId === Number(orderId));
          if (isSellerOrder) {
            const specificOrder = supplierOrders.find((o) => o.orderId === Number(orderId));
        ...
        if (user?.role === "designer") {
          ...
          const isSellerOrder = designerOrders.some((o) => o.orderId === Number(orderId));
          if (isSellerOrder) {
            const specificOrder = designerOrders.find((o) => o.orderId === Number(orderId));
            setData(specificOrder);
              ...
              "processing") && (
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center ${data.fulfillmentStatus === "Processing"
                          ? "bg-blue-500"
                          : "bg-amber-500"
                          }`}
                      >
                      ...
                      <div className="flex-1">
                        <div
                          className={`font-medium ${data.fulfillmentStatus === "Processing"
                            ? "text-blue-700"
                            : "text-amber-700"
                            }`}
                        >
              ...
              "delivered") && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div
                      className={`flex items-center gap-4 ${String(data.fulfillmentStatus || "").toLowerCase() ===
                        "delivered"
                        ? ""
                        : ""
                        }`}
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600">
                          {trackingInfo
                            ? `Mã vận đơn: ${trackingInfo.trackingNumber || "Đang cập nhật"
                    ...
                    >
                      <div
                        className={`w-6 h-6 rounded-full flex items-center justify-center ${String(data.fulfillmentStatus || "").toLowerCase() ===
                          "delivered"
                          ? "bg-green-500"
                          : "bg-gray-300"
                          }`}
                      ...
                      <div className="flex-1">
                        <div
                          className={`font-medium ${String(data.fulfillmentStatus || "").toLowerCase() ===
                            "delivered"
                            ? "text-green-700"
                            : "text-gray-500"
                            }`}
                        ...
                        <div
                          className={`text-sm ${String(data.fulfillmentStatus || "").toLowerCase() ===
                            "delivered"
                            ? "text-gray-600"
                            : "text-gray-400"
                            }`}
