            ...
            {!isLoadingData && !hasError && (
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="dashboard-card mb-8 rounded-xl shadow-md border border-gray-200 bg-white dark:bg-gray-900">
                  <div className="card-header px-6 pt-6 pb-2">
                    <h3 className="card-title text-lg font-bold text-brand-700">
                      Chỉ Số Bền Vững Hệ Thống Sử Dụng
                    </h3>
                    <p className="card-subtitle text-sm text-gray-500">
                ...
                <div className="dashboard-card mb-8 rounded-xl shadow-md border border-gray-200 bg-white dark:bg-gray-900">
                  <div className="card-header px-6 pt-6 pb-2">
                    <h3 className="card-title text-lg font-bold text-brand-700">
                     Nơi Sản Xuất & Chứng Chỉ Bền Vững Chuyên Ngành
                    </h3>
                    <p className="card-subtitle text-sm text-gray-500">
                  ...
                  <div className="card-body px-6 pb-6 pt-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="form-group md:col-span-2">
                        ...
                        <div className="mb-4">
                          <h1 className="text-3xl font-medium text-black-500 mb-2 flex items-center gap-2">
                            <svg className="w-8 h-8 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            Chọn chứng chỉ bạn cần cấp cho vật liệu vải này
                            <span className="text-sm">( không có chứng chỉ bỏ qua bước này)</span>
                          </h1>
                          <div className="pt-1 grid grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        {selectedCertifications.size > 0 && (
                          <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <p className="text-xs text-green-600 mt-2">
                              💡 Tiêu chí hệ thống cho điểm bền vững: Có chứng chỉ = 100 điểm (=20%) | Không có chứng chỉ =
                              0 điểm (=0%)
                            </p>
                          </div>
                        )}
