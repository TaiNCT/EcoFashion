...
export default function DesignerProfile() {
  ...
  const displayName = combinedDesigner?.designerName || combinedDesigner?.user?.fullName || "Nhà thiết kế";
  const displayEmail = combinedDesigner?.email || combinedDesigner?.user?.email || "Chưa cập nhật";
  const displayPhone = combinedDesigner?.phoneNumber || combinedDesigner?.user?.phone || "Chưa cập nhật";
