...
import { DesignerService, type DesignerModel } from "../../services/api/designerService";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium">{designer.designerName || "Chưa cập nhật"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium text-green-600 capitalize">{designer.status || "Hoạt động"}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium">{designer.phoneNumber || "Chưa cập nhật"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium">{designer.address || "Chưa cập nhật"}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium">{designer.taxNumber || "Chưa cập nhật"}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="font-medium">{designer.identificationNumber || "Chưa cập nhật"}</p>
            </div>
          </div>
        </div>
...
export default function DesignerDetailedProfile() {
  ...
  const { data: designer, isLoading, error: queryError } = useQuery({
  ...
  const bannerUrl = combinedDesigner?.bannerUrl && combinedDesigner.bannerUrl.trim() 
    ? combinedDesigner.bannerUrl 
    : bg;
  
  const avatarUrl = combinedDesigner?.avatarUrl && combinedDesigner.avatarUrl.trim() 
