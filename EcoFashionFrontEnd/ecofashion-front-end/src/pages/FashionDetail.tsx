...
import { AddToCart, ArrowBackIcon, ArrowForwardIcon } from "./Homepages";
...
//   <svg height="30" version="1.1" width="30" xmlns="http://www.w3.org/2000/svg">
    ...
    <Box sx={{ mx: "auto" }}>
      ...
      >
        <Breadcrumbs separator="›" aria-label="breadcrumb">
          ...
          <Typography color="text.primary">Quần Linen Lambretta</Typography>
        </Breadcrumbs>
      </AppBar>
      ...
      >
        ...
        >
          <Avatar sx={{ margin: "auto 10px", height: "80px", width: "80px" }} />
          ...
          <Box sx={{ display: "flex" }}>
            ...
            <Grid>
              ...
              >
                ...
                {"\n"}- Chất liệu 100% linen cao cấp, đã trải qua bước xử lý vải
                giúp làm mềm và không co rút khi giặt.
            ...
            <Box sx={{ display: "flex", width: "100%", margin: "auto" }}>
              ...
              <Grid sx={{ width: "40%", marginRight: "auto" }}>
                ...
                >
                  ...
                  trình quyên góp quần áo. Những món đồ này được phân loại, làm
                  sạch và xử lý để tách sợi vải.
                  {"\n"}Sau đó, các sợi vải được xoắn thành sợi chỉ mới và dệt
                  thành vải denim. Quá trình này sử dụng lượng nước, năng lượng
                  và hóa chất ít hơn đáng kể so với sản xuất denim thông thường.
                  Các thành phần polyester tái chế được làm từ những chai nhựa
                  đã được thu thập, làm sạch và xử lý thành sợi polyester.
                </Typography>
              </Grid>
            ...
            <Grid sx={{ width: "30%" }}>
              <Box sx={{ p: 2, border: "1px solid #eee", borderRadius: 2 }}>
                ...
                {ratingData.map((item) => (
                  ...
                  >
                    <Typography sx={{ width: 40 }}>{item.star} star</Typography>
                    <LinearProgress
                      variant="determinate"
                      value={item.value}
                      sx={{
          ...
          <Box sx={{ display: "flex" }}>
            ...
            <Grid sx={{ flex: 1 }}>
              ...
              <Typography
                ...
                sx={{ whiteSpace: "pre-line", fontSize: "15px" }}
              >
                Chúng tôi muốn bạn hoàn toàn hài lòng với sản phẩm của mình. Nếu
                bạn không hài lòng với đơn hàng, chúng tôi chấp nhận trả hàng
              ...
              <List>
                <ListItem>
                  Sản phẩm phải chưa qua sử dụng, chưa giặt và còn nguyên trạng
                  với nhãn mác đầy đủ
                </ListItem>
                <ListItem>
      ...
      <Box sx={{ margin: "30px 0" }}>
        ...
        >
          ...
          {products.map((item, index) => (
            <Card key={index} sx={{ width: "20%", m: 1, position: "relative" }}>
              <Box
                sx={{
                  p: 1,
                  position: "absolute",
